...
ActiveRecord::Schema.define(version: 20150205234301) do
  ...
  add_index "runs", ["difficulty_id"], name: "index_runs_on_difficulty_id", using: :btree
  add_index "runs", ["player_count"], name: "index_runs_on_player_count", using: :btree
  add_index "runs", ["toon_id"], name: "index_runs_on_toon_id", using: :btree
  ...
  add_index "toons", ["archetype_id"], name: "index_toons_on_archetype_id", using: :btree
  add_index "toons", ["user_id"], name: "index_toons_on_user_id", using: :btree
